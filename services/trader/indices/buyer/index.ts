...
import { getAllCryptoEvents, getAllIndicesEvents } from '../../../polymarket/events';
...
export const buyIndicesEvents = async () => {
  const [indicesEvents, positions, orders] = await Promise.all([getAllIndicesEvents(), getUserPositions(), getOpenOrders()]);
